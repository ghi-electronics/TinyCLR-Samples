...
namespace InterTest {
    class Program {
        static void Main() {
            ...
            const UInt32 RLI_ADDRESS = 0x20016000;
            ...
            UInt32[] Data = new UInt32[2] { 0x12345678, 0x98765432 }; // 8-byte block
            UInt32[] Key = new UInt32[4] { 0x11111111, 0x22222222, 0x33333333, 0x44444444 }; // 128-bit key
