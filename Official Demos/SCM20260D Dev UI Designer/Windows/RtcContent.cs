...
namespace Demos {
    // Code-behind for RtcContent.tcui. Exposes the two designed elements so the hosting RtcWindow
    ...
    public partial class RtcContent : Canvas {
        public RtcContent() => InitializeComponent();
