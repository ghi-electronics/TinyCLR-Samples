...
namespace Demos {
    // Code-behind for BuzzerContent.tcui. Exposes the two designed elements so the hosting BuzzerWindow
    ...
    public partial class BuzzerContent : Canvas {
        public BuzzerContent() => InitializeComponent();
