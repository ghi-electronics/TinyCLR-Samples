...
namespace Demos {
    // Code-behind for SdContent.tcui. Exposes the two designed elements so the hosting SdWindow
    ...
    public partial class SdContent : Canvas {
        public SdContent() => InitializeComponent();
