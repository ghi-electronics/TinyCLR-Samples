...
namespace GHIElectronics.TinyCLR.Glide
{
    ...
    public static class GlideLoader
    {
        ...
        private static GlideWindow _window = null;
        ...
        public static GlideWindow LoadWindow(string xmlStr)
        {
        ...
        private static ElementContainer GetComponent(XmlReader reader)
        {
            switch (reader.Name)
            {
                case "Button":
        ...
        private static ElementContainer LoadButton(XmlReader reader)
        {
            string name = reader.GetAttribute("Name");
            ...
            */
            return new ElementContainer(name, button);
        }
        ...
        private static ElementContainer LoadCheckBox(XmlReader reader)
        {
            string name = reader.GetAttribute("Name");
            ...
            return new ElementContainer(name, checkBox);
        }
        ...
        private static ElementContainer LoadDropdown(XmlReader reader)
        {
            string name = reader.GetAttribute("Name");
            ushort alpha = (reader.GetAttribute("Alpha") != null) ? Convert.ToUInt16(reader.GetAttribute("Alpha")) : _defaultDisplayObject.Alpha;
            int x = Convert.ToInt32(reader.GetAttribute("X"));
            ...
            return new ElementContainer(name, dropdown);
        }
        private static ElementContainer LoadComboBox(XmlReader reader)
        {
            string name = reader.GetAttribute("Name");
            ushort alpha = (reader.GetAttribute("Alpha") != null) ? Convert.ToUInt16(reader.GetAttribute("Alpha")) : _defaultDisplayObject.Alpha;
            int x = Convert.ToInt32(reader.GetAttribute("X"));
            ...
            return new ElementContainer(name, combo);
        }
        /// <summary>
        ...
        private static ElementContainer LoadDataGrid(XmlReader reader)
        {
            string name = reader.GetAttribute("Name");
            ushort alpha = (reader.GetAttribute("Alpha") != null) ? Convert.ToUInt16(reader.GetAttribute("Alpha")) : _defaultDisplayObject.Alpha;
            int x = Convert.ToInt32(reader.GetAttribute("X"));
            ...
            return new ElementContainer(name, dataGrid);
        }
        ...
        private static ElementContainer LoadImage(XmlReader reader)
        {
            string name = reader.GetAttribute("Name");
            ushort alpha = (reader.GetAttribute("Alpha") != null) ? Convert.ToUInt16(reader.GetAttribute("Alpha")) : _defaultDisplayObject.Alpha;
            int x = Convert.ToInt32(reader.GetAttribute("X"));
            ...
            return new ElementContainer(name, image);
        }
        ...
        private static ElementContainer LoadPasswordBox(XmlReader reader)
        {
            string name = reader.GetAttribute("Name");
            ushort alpha = (reader.GetAttribute("Alpha") != null) ? Convert.ToUInt16(reader.GetAttribute("Alpha")) : _defaultDisplayObject.Alpha;
            int x = Convert.ToInt32(reader.GetAttribute("X"));
            ...
            return new ElementContainer(name, passwordBox);
        }
        ...
        private static ElementContainer LoadProgressBar(XmlReader reader)
        {
            string name = reader.GetAttribute("Name");
            ushort alpha = (reader.GetAttribute("Alpha") != null) ? Convert.ToUInt16(reader.GetAttribute("Alpha")) : _defaultDisplayObject.Alpha;
            int x = Convert.ToInt32(reader.GetAttribute("X"));
            ...
            return new ElementContainer(name, progressBar);
        }
        ...
        private static ElementContainer LoadRadioButton(XmlReader reader)
        {
            string name = reader.GetAttribute("Name");
            int x = Convert.ToInt32(reader.GetAttribute("X"));
            int y = Convert.ToInt32(reader.GetAttribute("Y"));
            ...
            return new ElementContainer(name, radioButton);
        }
        ...
        private static ElementContainer LoadSlider(XmlReader reader)
        {
            string name = reader.GetAttribute("Name");
            ushort alpha = (reader.GetAttribute("Alpha") != null) ? Convert.ToUInt16(reader.GetAttribute("Alpha")) : _defaultDisplayObject.Alpha;
            int x = Convert.ToInt32(reader.GetAttribute("X"));
            ...
            return new ElementContainer(name, slider);
        }
        ...
        private static ElementContainer LoadTextBlock(XmlReader reader)
        {
            string name = reader.GetAttribute("Name");
            ushort alpha = (reader.GetAttribute("Alpha") != null) ? Convert.ToUInt16(reader.GetAttribute("Alpha")) : _defaultDisplayObject.Alpha;
            int x = Convert.ToInt32(reader.GetAttribute("X"));
            ...
            return new ElementContainer(name, textBlock);
        }
        ...
        private static ElementContainer LoadTextBox(XmlReader reader)
        {
            string name = reader.GetAttribute("Name");
            ushort alpha = (reader.GetAttribute("Alpha") != null) ? Convert.ToUInt16(reader.GetAttribute("Alpha")) : _defaultDisplayObject.Alpha;
            int x = Convert.ToInt32(reader.GetAttribute("X"));
            ...
            return new ElementContainer(name, textBox);
        }
    }
}
